                ...
                <Box display="flex" justifyContent="center">
                    <Paper elevation={3} style={{ width: "400px", height: "200px", backgroundColor: "#473810" }}>
                        <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" height="100%">
                            ...
                            <Typography variant="h6" textAlign="center" color="white">9</Typography>
                        </Box>
                    </Paper>
                </Box>
            </Grid>
                ...
                <Box display="flex" justifyContent="center">
                    <Paper elevation={3} style={{ width: "400px", height: "200px", backgroundColor: "#033E3E" }}>
                        <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" height="100%">
                            ...
                            <Typography variant="h6" textAlign="center" color="white">4</Typography>
                        </Box>
                    </Paper>
                </Box>
            </Grid>
                ...
                <Box display="flex" justifyContent="center">
                    <Paper elevation={3} style={{ width: "400px", height: "200px", backgroundColor: "#254117" }}>
                        <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" height="100%">
                            ...
                            <Typography variant="h6" textAlign="center" color="white">5</Typography>
                        </Box>
                    </Paper>
                </Box>
            </Grid>
